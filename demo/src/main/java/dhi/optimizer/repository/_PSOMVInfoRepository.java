 ...
 */
@Repository
public interface _PSOMVInfoRepository extends JpaRepository<_PSOMVInfoEntity, String> {
	...
	List<_PSOMVInfoEntity> findByPsoMVInOrderByPsoMVOrderAsc(Collection<String> psoMVs);
