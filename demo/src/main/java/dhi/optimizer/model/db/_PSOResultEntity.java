...
/*
 * DB Table Model Class using JPA.(DD_TB_PSO_RESULT)
 */
@Entity
@Table(name = "DD_TB_PSO_RESULT")
public class _PSOResultEntity {

	@EmbeddedId
	private _PSOResultIdEntity id;
	...
	public _PSOResultIdEntity getId() {
		return id;
	}

	public void setId(_PSOResultIdEntity id) {
		this.id = id;
	}
